...
export const productionCases = [
  ...
  },
  {
    ...
    task: "Commissioned by Stone Island for the brand's expansion into the American market, produced through MR PORTER The Journal as on-the-ground production lead across Long Island. Brief called for a deliberate move away from traditional fashion casting in favour of a real-world feature anchored in the East Coast sailing community, with Stone Island positioned as the working uniform of the lifestyle rather than the subject of the story.",
    outcome: "Partnered with Establishment NYC to street-cast four working sailors from inside the community: a captain from Saint Martin, a photographer and freelance delivery skipper, a former professional surfer turned schooner crew, and a Long Island shipwright. Scouted shoot locations across Long Island's marinas, boatyards and North Fork harbours to match the working environments each subject actually operated in. The resulting MR PORTER Journal feature read as profile journalism on American maritime culture rather than a brand campaign, with Stone Island's collection grounded in the lives of the men actually wearing it. Photography by Jon Ervin, writing by John Lockett, styling by Mac Huelster.",
...
export const CATEGORY_BY_SLUG = {
  ...
  "stone-island-life-aquatic": "/production",
