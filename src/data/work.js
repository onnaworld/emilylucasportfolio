...
export const productionCases = [
  ...
  },
  {
    ...
    outcome: "Curated six photographers across four continents — Alexandra Leese (Hong Kong), Natela Grigalashvili (Georgia), Alex de Mora (Mongolia), Kemka Ajoku (Nigeria), Bettina Pittaluga (France/Uruguay), and Carl van der Linde (South Africa/Zanzibar) — each working in their own cultural context or as outsiders documenting one. Built the editorial structure to let each photographer speak directly to their own ethical practice, paired with imagery from their published projects. The piece functioned as both reference and statement of position: ethical photography as a discipline rooted in relationship, consent, and time spent, not as a checklist applied at the edit stage.",
