...
export const productionCases = [
  {
    ...
    owned: "Owned the visual campaign for Aman's upcoming Saudi Arabia properties, translating an abstract, atmosphere-driven creative brief into cinematic assets across vast regional landscapes before physical completion.",
    result: "Delivered a comprehensive library of cinematic assets that initiated the brand's market presence and residential sales with a visual language that felt established, authentic and uncompromisingly Aman.",
  ...
  },
  {
    ...
    owned: "Owned the on-the-ground execution for Nike's global Vomero 18 launch across activations at Kite Beach and the Burj Khalifa, bridging global creative standards with regional execution and facilitating the workflow for Photographer/Director Will Beach.",
    result: "Delivered Nike-standard assets that solidified long-term relationships between global creative talent and regional distributors.",
    team: "Photographer/Director: Will Beach.",
  ...
  },
  {
    ...
    role: "Production Lead",
    owned: "Commissioned by agency IMA MENA to lead production of a Ramadan 2026 activation, translating brand presence into an experience that respected the rhythm of fasting and community spirit over borrowed iconography.",
    result: "Delivered a pre-dawn hike timed to suhoor, iftar at the summit and fasting-respectful catering, anchoring the activation in lived cultural practice and covered by Hypebeast.",
    team: "Agency: IMA MENA.",
  ...
  },
  {
    ...
    year: "2024",
    role: "Production Lead",
    owned: "Led production on a tier-1 talent shoot with Finneas for MR PORTER in Los Angeles, partnering with a local LA crew and Wilson Project to deliver an editorial-quality, set-built shoot in a single day without compromising the MR PORTER standard.",
    result: "Delivered the feature that ran across MR PORTER's Journal as a Q&A spanning Finneas's work on Barbie, the Bond franchise and his Grammy wins.",
    team: "Production Partner: Wilson Project.",
  ...
  },
  {
    ...
    owned: "Owned on-set logistics, vendor management and creator coordination for Charlotte Tilbury's $1M+ global Disney 100 activation, coordinating tier-1 content creators alongside the CT pro artist team and stylist Nathan Klein.",
    result: "The campaign rolled out globally as one of Charlotte Tilbury's flagship cultural moments of the year, a high-water mark for beauty x entertainment IP activations.",
    team: "Stylist: Nathan Klein. Talent: Monet McMichael, Victor Kunda, Danielle Marcan.",
    images: [
  ...
  },
  {
    ...
    role: "Senior Editorial Producer (In-House)",
    owned: "Owned Harvey Nichols' festive season content engine: a single-day, 40+ asset festive shoot on a built set, a still-life gifting campaign, and a social-first beauty shoot, all within tight budget parameters.",
    result: "Delivered the full festive content engine across digital, print and in-store, plus social-native beauty video built for speed and channel performance, without compromising the brand's luxury retail standard.",
    videoLinks: {
  ...
  },
  {
    ...
    year: "2024",
    role: "Freelance Senior Producer",
    owned: "Owned end-to-end production in Abu Dhabi for GUESS's global Ramadan OOH campaign, talent through crew through location through on-set execution, landing authentically in the GCC market while meeting GUESS's global brand standards.",
    result: "Delivered global OOH placements timed to Ramadan, rolled out across print publications and in-store.",
    images: [
  ...
  },
  {
    ...
    year: "2024",
    role: "Freelance Senior Producer",
    owned: "Owned a multi-location stills and video campaign for SIRO Hotel Dubai, navigating the city's roads and key brand locations alongside a regional production house.",
    result: "Landed as one of the first major hospitality projects within six months of establishing in the Dubai market, opening the door to further regional hospitality production work.",
    images: [
  ...
  },
  {
    ...
    year: "2024",
    role: "Freelance Production Support",
    owned: "Owned casting and location scouting in London for the Hamilton Watches Ventura XXL stills and video campaign, working within director Paul Hempstead's creative direction.",
    result: "Added watches to the production portfolio as a new luxury category.",
    team: "Director: Paul Hempstead.",
  ...
  },
  {
    ...
    owned: "Owned all Dubai-side logistics for London-based agency Noë & Associates' visual campaign at the Al Bahar villa, Jumeirah Beach Hotel, from location permits through equipment and fittings, so the London creative team could focus on direction.",
    result: "Delivered the campaign and strengthened the working relationship with Noë & Associates across multiple regional luxury hospitality projects.",
    team: "Agency: Noë & Associates.",
    images: [
  ...
  },
  {
    ...
    owned: "Led three community-rooted campaigns at MR PORTER over three years: London's roller-skating scene (Feels on Wheels, part of the Tee Store men's mental health initiative), a Black British writers portfolio, and the brand's Pride social takeover, organically casting from within each community, including LGBTQAI casting partner Queer Direct.",
    result: "Established a programmatic approach to cultural production at MR PORTER, where community sourcing was the strategy, not a credit at the end.",
    team: "Photography (Pride): Charlotte Hadden. Casting Partner (Pride): Queer Direct.",
    viewProjectLink: [
  ...
  },
  {
    ...
    owned: "Led MR PORTER's social media production strategy for its Gen Z push, building and launching the content calendar adopted by the entire social team, working alongside the Social Art Director, Editor, Strategist and Influencer & Partnerships Manager.",
    result: "Grew the TikTok channel to 50K followers in its first year via the Helping Hands and community-led Ask Mr Porter franchise formats, establishing the social production playbook MR PORTER continued to build on.",
    videoLinks: {
      "/work/mr-porter-social-media-strategy/01.mp4": "https://www.instagram.com/reels/C0zM2zut65S/",
      "/work/mr-porter-social-media-strategy/02.mp4": "https://www.instagram.com/reels/C3VdDJPN0fY/",
  ...
  },
  {
    ...
    role: "Production Lead",
    owned: "Owned production through Vogue Arabia's critical transition back to Condé Nast, managing the creative workflow of Luc Braquet and Txema Yeste across the first three relaunch issues within strict editorial budgets and extreme timelines.",
    result: "Delivered three flagship relaunch issues and world-class covers/editorials that re-established the title's authority within the global Vogue ecosystem.",
    team: "Creative Direction: Luc Braquet. Photography: Txema Yeste. Talent: Imaan Hammam, Achraf Hakimi, Halima Aden, Balqees Fathi.",
    images: [
  ...
  },
  {
    ...
    role: "Production Support",
    owned: "Owned location scouting and a street-casting initiative for J.Crew's shoot at the historic Abraham Moon mill, working with director Paul Hempstead to move away from traditional fashion casting toward real community faces.",
    result: "Activated the local community as cast: farmers, athletes, musicians and business owners, in a production where human authenticity sat at the heart of every frame.",
    team: "Director: Paul Hempstead.",
  ...
  },
  {
    ...
    role: "Production Lead",
    owned: "Commissioned by global agency Octagon to deliver Mastercard's inaugural SailGP partnership, capturing the 6th Sailor Experience with Luís Figo and the New Zealand Black Foils on a restricted timeline against three institutions' standards.",
    result: "Delivered a 48-hour live-edit turnaround for first-round approval, exceeding budget expectations and earning a commitment to long-term collaboration across GCC projects with Octagon.",
    team: "Agency: Octagon. Talent: Luís Figo.",
  ...
  },
  {
    ...
    role: "Executive Producer",
    owned: "Owned the client relationship and production from planning through postproduction for One&Only's first North American mountain resort, partnering with US-based production house Willson Project to bridge a Middle Eastern base with a remote Big Sky, Montana location.",
    result: "Delivered a seamless transcontinental workflow that proved scalable global operations regardless of regional distance.",
    team: "Production Partner: Willson Project.",
  ...
  },
  {
    ...
    role: "On-the-Ground Production Lead",
    owned: "Owned Dubai-side production for Noë & Associates' Mr. C Residences Downtown launch, navigating a sensitive, live residential environment between London's creative direction and Dubai's logistical realities.",
    result: "Delivered a suite of assets that maintained Cipriani's Italian heritage while speaking to the Dubai luxury market.",
    team: "Agency: Noë & Associates.",
  ...
  },
  {
    ...
    role: "Production Lead",
    owned: "Owned an inaugural Doha production for Vogue Arabia, brokering location logistics at the National Museum of Qatar for emerging designer Yasmin Mansour following her LVMH Prize win.",
    result: "Mobilised a specialised Dubai-based creative team across borders for a high-fashion shoot inside a state-level cultural institution, proving the capacity to export production standards across the GCC.",
    images: [
  ...
  },
  {
    ...
    role: "Commercial Production Lead",
    owned: "Owned a series of high-stakes commercial executions for Vogue Arabia's advertiser partners including Bvlgari, following on from the editorial relaunch, integrating the brand's identity while managing complex advertiser requirements.",
    result: "Became Vogue Arabia's primary partner for its most demanding advertiser projects, extending the in-house team's capacity at peak load.",
    images: [
  ...
  },
  {
    ...
    role: "On-the-Ground Production Lead",
    owned: "Led production across Long Island for Stone Island's US market expansion via MR PORTER The Journal, partnering with Establishment NYC to street-cast four working sailors and scout marinas, boatyards and North Fork harbours matching their real working environments.",
    result: "Delivered a MR PORTER Journal feature that read as profile journalism on American maritime culture, with Stone Island grounded in the lives of the people actually wearing it, not positioned as the subject of the story.",
    team: "Photography: Jon Ervin. Writing: John Lockett. Styling: Mac Huelster. Casting Partner: Establishment NYC.",
  ...
  },
  {
    ...
    role: "Production Lead",
    owned: "Owned fashion production for Louis Vuitton within The Glass Magazine's editorial framework, managing specialised technical requirements and high-value fine jewellery handling to hold Louis Vuitton's seasonal narrative through every frame.",
    result: "Delivered imagery that met the rigorous benchmarks of both the publication and the Maison.",
    images: [
  ...
  },
  {
    ...
    role: "US Production Lead",
    owned: "Led US production for MR PORTER In America, a 360° multi-brand campaign across LA, New York and Miami, coordinating a Hennessy brand partnership and editorial partnerships with The Elder Statesman, Polite Worldwide and Greg Lauren across photography, film and digital.",
    result: "Generated 2.65M views and a 75% engagement uplift, building the on-the-ground US framework for one of MR PORTER's flagship annual campaigns.",
