...
export const productionCases = [
  ...
  },
  {
    ...
    year: "2025",
    task: "Production partner to London-based agency Noë & Associates on the visual campaign for the private villas at Jumeirah's Marsa Al Arab property. On-the-ground production lead handling permitting, equipment sourcing, fittings, and all Dubai-side logistics.",
    outcome: "Delivered the campaign across the private villas, managing every layer of regional execution (from location permits through equipment and fittings), so that the London creative team could focus on direction and delivery. Strengthened the working relationship with Noë & Associates across multiple regional Jumeirah and luxury hospitality projects.",
    images: [
  ...
  },
  {
    ...
    year: "2022",
    task: "Concept, research, and authorship of a long-form feature for Trippin on ethical photography practice. Brief: build a piece that interrogated the power dynamics of photography across cultures (particularly the documentation of unfamiliar places by visiting photographers), and surface that conversation through voices working at the front of the conversation, not theorising about it from outside.",
    outcome: "Curated six photographers across four continents (Alexandra Leese in Hong Kong, Natela Grigalashvili in Georgia, Alex de Mora in Mongolia, Kemka Ajoku in Nigeria, Bettina Pittaluga in France/Uruguay, and Carl van der Linde in South Africa/Zanzibar), each working in their own cultural context or as outsiders documenting one. Built the editorial structure to let each photographer speak directly to their own ethical practice, paired with imagery from their published projects. The piece functioned as both reference and statement of position: ethical photography as a discipline rooted in relationship, consent, and time spent, not as a checklist applied at the edit stage.",
  ...
  },
  {
    ...
    year: "2022",
    task: "Authored editorial trend forecast for the MR PORTER Journal entering 2022. Brief: build a credible menswear trend piece for the start of the year: concept the trends, write the editorial, and source the visual research. Not a curated pull from existing forecaster reports, but an original read of the menswear landscape based on the runway, street, and emerging cultural signals.",
